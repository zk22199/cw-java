                        ...
                        if ((a.location() == destination1) || (a.location() == destination2)) {
                            ...
                            for (Transport t1 : setup.graph.edgeValueOrDefault(source, destination1, ImmutableSet.of())) {
                                ...
                                for (Transport t2 : setup.graph.edgeValueOrDefault(destination1, destination2, ImmutableSet.of())) {
                                    ...
                                    if (player.has(Ticket.SECRET) && player.has(t2.requiredTicket())) {

                                        doubleMoves.add(new DoubleMove(player.piece(), source, Ticket.SECRET, destination1, t2.requiredTicket(), destination2));

                                    }
                                    if (player.has(Ticket.SECRET) && player.has(t1.requiredTicket())) {
